...
<body>
    ...
    <div class="dashboard-container">
        <a href="<?= base_url('tablaCategorias') ?>" class="dashboard-item">
            <h2>Gestionar categorias</h2>
            <p>Categorias</p>
        </a>
        <a href="<?= base_url('tablaAutores') ?>" class="dashboard-item">
            <h2>Gestionar autores</h2>
            <p>Categorias</p>
        </a>
        <a href="<?= base_url('tablaLibrosb') ?>" class="dashboard-item">
