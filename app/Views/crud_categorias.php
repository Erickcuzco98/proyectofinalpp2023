...
<body style="background-color: #b6d7a8;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="display-4">Dashboard de Bibliotecario - Categorias </h1>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $fila['nombre'] ?></td>
                        <td class="acciones">
                        <a href="<?= base_url("verCategoria/" . $fila['categoria_id']) ?>" class="btn btn-warning"><i class="fas fa-pen"></i></a>
                            <a onclick="return confirm('¿Está seguro de eliminar?');" href="<?= base_url("eliminarCategoria/" . $fila['categoria_id']) ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                <?php
                }
